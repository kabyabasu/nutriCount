...
def app():
    ...
    col2.write(f"Required weight Change (in KG) {round(current_required_weight_change,1)}")
    col2.write(f"Required minimum weight Change (in KG){round(current_required_min_weight_change,1)}")
    col2.write(f"Your Maintenance Calorific Intake is (in KG){round(current_maintainance_calorific_intake,1)}")
